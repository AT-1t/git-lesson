...
def retrieve_sdf(molecule_name: str) -> str:
    ...
    sdf_url = (#f"https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/CID/2244/record/SDF?record_type=2d&response_type=display")

        https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/{aspring}/SDF")
